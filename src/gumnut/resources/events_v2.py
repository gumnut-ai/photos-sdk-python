...
from ..types import events_v2_get_params
...
from ..types.events_v2_response import EventsV2Response

__all__ = ["EventsV2Resource", "AsyncEventsV2Resource"]


class EventsV2Resource(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> EventsV2ResourceWithRawResponse:
        """
        ...
        """
        return EventsV2ResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> EventsV2ResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/gumnut-ai/photos-sdk-python#with_streaming_response
        """
        return EventsV2ResourceWithStreamingResponse(self)
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    events_v2_get_params.EventsV2GetParams,
                ),
            ),
            cast_to=EventsV2Response,
        )


class AsyncEventsV2Resource(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncEventsV2ResourceWithRawResponse:
        """
        This property can be used as a prefix for any HTTP method call to return
        the raw response object instead of the parsed content.
        ...
        For more information, see https://www.github.com/gumnut-ai/photos-sdk-python#accessing-raw-response-data-eg-headers
        """
        return AsyncEventsV2ResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncEventsV2ResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/gumnut-ai/photos-sdk-python#with_streaming_response
        """
        return AsyncEventsV2ResourceWithStreamingResponse(self)
...
class EventsV2ResourceWithRawResponse:
    def __init__(self, events_v2: EventsV2Resource) -> None:
        self._events_v2 = events_v2
...
class AsyncEventsV2ResourceWithRawResponse:
    def __init__(self, events_v2: AsyncEventsV2Resource) -> None:
        self._events_v2 = events_v2
...
class EventsV2ResourceWithStreamingResponse:
    def __init__(self, events_v2: EventsV2Resource) -> None:
        self._events_v2 = events_v2
...
class AsyncEventsV2ResourceWithStreamingResponse:
    def __init__(self, events_v2: AsyncEventsV2Resource) -> None:
        self._events_v2 = events_v2
