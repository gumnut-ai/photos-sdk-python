...
__all__ = ["TaskListForAssetResponse", "TaskListForAssetResponseItem"]


class TaskListForAssetResponseItem(BaseModel):
...
TaskListForAssetResponse: TypeAlias = List[TaskListForAssetResponseItem]
